...
#include <wx/utils.h>
#include <sstream>
V_SumarCarrito::V_SumarCarrito(wxWindow *parent,CarritoDeCompras* c,Producto* a) : AddCarrito(parent), carrito(c), prod(a) {
	if(!carrito){
...
void V_SumarCarrito::OnOK( wxCommandEvent& event )  {
...
V_SumarCarrito::~V_SumarCarrito() {
	
}
void V_SumarCarrito::OnClose (wxCloseEvent & event) {
